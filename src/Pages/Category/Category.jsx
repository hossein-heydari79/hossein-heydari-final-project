    ...
    const request = () => {
        fetch("/" + name)
            ...
            .then(result => {
                ...
                brandFilter && (products = products.filter((item) => item.brand === brandFilter))
                romFilter && (products = products.filter((item) => item.specifications && (item.specifications.rom === romFilter)))
                displayFilter && (products = products.filter((item) => item.specifications && (item.specifications.display === displayFilter)))
                connectionFilter && (products = products.filter((item) => item.specifications && (item.specifications.connection === connectionFilter)))
                setItems(products)
            })
    }
    useEffect(() => {
